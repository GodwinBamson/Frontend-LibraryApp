...
// import { UserCircleIcon, EnvelopeIcon, IdentificationIcon, CalendarIcon } from '@heroicons/react/24/outline';
...
//                                                     <div className="font-medium text-gray-900">{userData.studentId}</div>
//                                                 </div>
//                                             </div>
//                                         )}
...
//                                                 {userData.borrowedBooks?.filter(b => !b.returned).length || 0}
//                                             </div>
...
//                                 <div className="mt-6">
//                                     <h4 className="font-medium text-gray-900 mb-3">Currently Borrowed Books</h4>
//                                     {userData.borrowedBooks?.filter(b => !b.returned).length > 0 ? (
//                                         <div className="space-y-3">
//                                             {userData.borrowedBooks
//                                                 .filter(b => !b.returned)
//                                                 .map((borrowed) => (
//                                                     <div key={borrowed._id} className="flex items-center justify-between bg-gray-50 p-3 rounded">
//                                                         <div>
//                                                             <div className="font-medium text-gray-900">
//                                                                 {borrowed.book?.title}
//                                                             </div>
//                                                             <div className="text-sm text-gray-500">
//                                                                 Due: {format(new Date(borrowed.dueDate), 'MMM dd, yyyy')}
//                                                             </div>
//                                                         </div>
//                                                     </div>
//                                                 ))}
...
import { useState, useEffect } from 'react';
import { authAPI } from '../services/api';
import { UserCircleIcon, EmailIcon, IdentificationIcon, CalendarIcon } from '../components/Icons';
