...
export default function BookDetail() {
  ...
  const handleRead = () => {
    if (book?.pdfUrl) {
      // Add parameters to disable toolbar for Cloudinary URLs
      if (book.pdfUrl.includes("cloudinary.com")) {
        window.open(
          `${book.pdfUrl}#toolbar=0&navpanes=0&scrollbar=0&view=FitH`,
          "_blank",
        );
      } else {
              ...
              {user?.role === "student" && (
                <div className="mt-4 p-4 bg-blue-50 rounded-md">
                  <p className="text-sm text-blue-800">
                    <span className="font-semibold">📚 Borrow Period:</span> 14
                    days
                  </p>
                  <p className="text-sm text-blue-800 mt-1">
                    <span className="font-semibold"> Late Return:</span> Overdue
                    books may incur penalties
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-900">
                    {book.title} - PDF Version
                  </p>
                  <p className="text-sm text-gray-500">
                    Click the button below to open the book in a new tab
                  </p>
                </div>
              </div>
              <button
